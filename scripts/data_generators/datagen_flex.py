...
for data_i in range(5000):
    ...
    # clusterStiffness = params_range[0][0] + params_offset[0] * 0
    # clusterPlasticThreshold = params_range[1][0] + params_offset[1] * 0
    # clusterPlasticCreep = params_range[2][0] + params_offset[2] * 2
