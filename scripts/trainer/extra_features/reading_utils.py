...
_FEATURE_DESCRIPTION = {
    ...
    'extra_features': tf.io.VarLenFeature(tf.string),
}
...
def parse_serialized_simulation_example(example_proto, metadata):
  ...
  if 'extra_mean' in metadata:
    extra_features_shape = [metadata['sequence_length'] + 1, -1, metadata['dim_extra']]
    parsed_features['extra_features'] = tf.reshape(parsed_features['extra_features'],
